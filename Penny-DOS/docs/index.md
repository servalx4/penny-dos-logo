# Penny-DOS Documentation.

## Getting Started.

To get started with these docs, please use the sidebar. The label `getting started` is for users, not developers/contributors. The label `contributing docs` are for developers/contributors. Please use that to get started.

## Project Stats.

- Current Build Version: 0.0.1-alpha
- Codename: `Clementine`
- Pre Release Date: 11/11/2025
- Next Build: 0.0.2-alpha
- Docs: In Progress, 1% complete.
- *other info unavaliable at this time*.
